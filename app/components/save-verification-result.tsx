...
import { RefreshCw, CheckCircle, Phone, Mail, Cookie, Apple, Chrome, Shield, Lock, AlertCircle } from "lucide-react"

interface SaveVerificationResultProps {
  onComplete: (saveMethod?: "phone" | "email" | "cookie" | "apple" | "google", identifier?: string) => void
  onSkip: () => void
  primaryColor: string
  buttonClass?: string
}
...
export default function SaveVerificationResult({
  ...
  const handleComplete = () => {
    // Předání metody uložení a identifikátoru
    ...
    onComplete(activeTab, identifier)
  }
      ...
      <div className="w-full">
        ...
        {!error && step === "select" && (
          <div>
            ...
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "phone" | "email" | "apple" | "google" | "cookie")} className="mb-6">
              ...
              <TabsContent value="google" className="mt-4">
                <div className="space-y-4">
                  ...
                  <Button
                    onClick={() => handleOAuthSave("google")}
                    className={`w-full ${buttonClass} bg-white text-gray-800 hover:bg-gray-100 border border-gray-300 flex items-center justify-center gap-2`}
                    disabled={!acceptTerms}
                  >
                    <Chrome className="h-5 w-5" />
                    Propojit s Google účtem
                  </Button>
                </div>
              </TabsContent>
            </Tabs>
            ...
            <div className="flex justify-center gap-4 mt-6">
              ...
              <Button onClick={handleComplete} style={{ backgroundColor: primaryColor }} className={buttonClass}>
                Dokončit
              </Button>
            </div>
          </div>
        ...
        {step === "result" && (
          <div className="text-center py-6">
            ...
            <Button onClick={handleComplete} className={`bg-green-600 hover:bg-green-700 ${buttonClass}`}>
              Dokončit
            </Button>
          </div>
        )}
