    ...
    try {
      ...
      if (methodId === "bankid" || methodId === "mojeid") {
        if (response.redirect_url) {
          ...
          // Pro BankID a MojeID přesměrujeme uživatele
            ...
            <div className="flex flex-col items-center text-white">
              {shopLogo && (
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl mb-4 inline-block">
                  <img src={shopLogo || DEFAULT_LOGO} alt="E-shop logo" className="h-12 max-w-[120px] object-contain" />
                </div>
              )}
